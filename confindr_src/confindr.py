...
def find_if_multibase(column, reference_sequence, quality_cutoff, base_cutoff, base_fraction_cutoff):
    """
...
def read_contig(contig_name, bamfile_name, reference_fasta, allele_records, quality_cutoff=20, base_cutoff=2,
    ...
    for column in bamfile.pileup(contig_name,
        ...
        base_dict = find_if_multibase(column=column,
